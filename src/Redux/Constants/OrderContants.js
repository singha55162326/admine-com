...
export const ORDER_NOTPAID_REQUEST = "ORDER_NOTPAID_REQUEST";
export const ORDER_NOTPAID_SUCCESS = "ORDER_NOTPAID_SUCCESS";
export const ORDER_NOTPAID_FAIL = "ORDER_NOTPAID_FAIL";
export const ORDER_NOTPAID_RESET = "ORDER_NOTPAID_RESET";